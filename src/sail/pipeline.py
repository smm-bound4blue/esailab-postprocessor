...
def _build_result_row(prow: pd.Series, pipeline_version: str) -> Dict[str, Any]:
    return {
        ...
        "cd_n": _get(prow, "CD_N"),
        "e": _get(prow, "E"),
        "cfx_sail": _get(prow, "CFX_SAIL"),
        "cfx_sail_n": _get(prow, "CFX_SAIL_N"),
        "cfx_sys": _get(prow, "CFX_SYS"),
        "cfx_sys_n": _get(prow, "CFX_SYS_N"),
        "cfy_sail": _get(prow, "CFY_SAIL"),
        "cfy_sail_n": _get(prow, "CFY_SAIL_N"),
        "cfy_sys": _get(prow, "CFY_SYS"),
        "cfy_sys_n": _get(prow, "CFY_SYS_N"),
        "cfz_sail": _get(prow, "CFZ_SAIL"),
        "cfz_sail_n": _get(prow, "CFZ_SAIL_N"),
        "cfz_sys": _get(prow, "CFZ_SYS"),
        "cfz_sys_n": _get(prow, "CFZ_SYS_N"),
        "cmx_pillar_1_7d_gnd": _get(prow, "CMX_PILLAR_1.7D_GND"),
        "cmx_pillar_1_7d_gnd_nm": _get(prow, "CMX_PILLAR_1.7D_GND_Nm"),
        "cmx_pillar_1_7d_trans": _get(prow, "CMX_PILLAR_1.7D_TRANS"),
        "cmx_pillar_1_7d_trans_nm": _get(prow, "CMX_PILLAR_1.7D_TRANS_Nm"),
        "cmx_pillar_base": _get(prow, "CMX_PILLAR_BASE"),
        "cmx_pillar_base_nm": _get(prow, "CMX_PILLAR_BASE_Nm"),
        "cmx_pillar_half": _get(prow, "CMX_PILLAR_HALF"),
        "cmx_pillar_half_nm": _get(prow, "CMX_PILLAR_HALF_Nm"),
        "cmx_sail_base": _get(prow, "CMX_SAIL_BASE"),
        "cmx_sail_base_nm": _get(prow, "CMX_SAIL_BASE_Nm"),
        "cmy_pillar_1_7d_gnd": _get(prow, "CMY_PILLAR_1.7D_GND"),
        "cmy_pillar_1_7d_gnd_nm": _get(prow, "CMY_PILLAR_1.7D_GND_Nm"),
        "cmy_pillar_1_7d_trans": _get(prow, "CMY_PILLAR_1.7D_TRANS"),
        "cmy_pillar_1_7d_trans_nm": _get(prow, "CMY_PILLAR_1.7D_TRANS_Nm"),
        "cmy_pillar_base": _get(prow, "CMY_PILLAR_BASE"),
        "cmy_pillar_base_nm": _get(prow, "CMY_PILLAR_BASE_Nm"),
        "cmy_pillar_half": _get(prow, "CMY_PILLAR_HALF"),
        "cmy_pillar_half_nm": _get(prow, "CMY_PILLAR_HALF_Nm"),
        "cmy_sail_base": _get(prow, "CMY_SAIL_BASE"),
        "cmy_sail_base_nm": _get(prow, "CMY_SAIL_BASE_Nm"),
        "cmz_pillar_1_7d_gnd": _get(prow, "CMZ_PILLAR_1.7D_GND"),
        "cmz_pillar_1_7d_gnd_nm": _get(prow, "CMZ_PILLAR_1.7D_GND_Nm"),
        "cmz_pillar_1_7d_trans": _get(prow, "CMZ_PILLAR_1.7D_TRANS"),
        "cmz_pillar_1_7d_trans_nm": _get(prow, "CMZ_PILLAR_1.7D_TRANS_Nm"),
        "cmz_pillar_base": _get(prow, "CMZ_PILLAR_BASE"),
        "cmz_pillar_base_nm": _get(prow, "CMZ_PILLAR_BASE_Nm"),
        "cmz_pillar_half": _get(prow, "CMZ_PILLAR_HALF"),
        "cmz_pillar_half_nm": _get(prow, "CMZ_PILLAR_HALF_Nm"),
        "cmz_sail_base": _get(prow, "CMZ_SAIL_BASE"),
        "cmz_sail_base_nm": _get(prow, "CMZ_SAIL_BASE_Nm"),
        "z_cp": _get(prow, "Z_CP"),
